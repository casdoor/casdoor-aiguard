...
// Unpatch and Status methods - see openclaw.go for a worked example. Patch must
// route every filesystem edit through the ChangeSet it is handed, which is what
// makes Unpatch a matter of calling Revert.
