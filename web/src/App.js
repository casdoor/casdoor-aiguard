...
import {DashboardOutlined, RobotOutlined, SafetyCertificateOutlined, SettingOutlined, ApiOutlined, FileTextOutlined, MessageOutlined, DesktopOutlined, IdcardOutlined, MergeCellsOutlined, BulbOutlined, CloudServerOutlined} from "@ant-design/icons";
...
const menuItems = [
  ...
  {key: "/llm-providers", icon: <CloudServerOutlined />, label: <Link to="/llm-providers">LLM Providers</Link>},
  ...
  {key: "/self-learning", icon: <BulbOutlined />, label: <Link to="/self-learning">Self-Learning</Link>},
          ...
          <Content style={{padding: 24}}>
            <div style={{background: "#fff", borderRadius: 8, border: "1px solid #f0f0f0", boxShadow: "0 1px 5px 0 rgba(51, 51, 51, 0.06)", padding: 24, minHeight: "100%"}}>
              <Switch>
                ...
                <Route exact path="/llm-providers" component={LLMProvidersPage} />
                ...
                <Route exact path="/self-learning" render={() => <SelfLearningPage account={account} />} />
