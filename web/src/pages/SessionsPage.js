  ...
  return (
    <div>
      <Space style={{display: "flex", justifyContent: "space-between", marginBottom: 16}}>
        <Tooltip title="One row per session key seen across the behaviour records. The title is the agent's own label for the session where it reports one - the same title `claude --resume` shows - and otherwise the first tool the session used.">
